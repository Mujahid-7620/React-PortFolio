      ...
      >
        ...
        <Box sx={{ maxWidth: 800, textAlign: 'center', marginBottom: 4 }}>
          ...
          <Typography variant="body1" sx={{ fontSize: '1.1rem', lineHeight: 1.6 }}>
            Hi, I'm <strong>Dnyaneshwari Garole</strong>, a passionate <strong>Java Full Stack Developer (Fresher)</strong> with a strong foundation in Computer Science Engineering. As a quick learner with a problem-solving mindset
