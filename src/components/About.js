      ...
      >
        ...
        <Box sx={{ maxWidth: 800, textAlign: 'center', marginBottom: 4 }}>
          ...
          <Typography variant="body1" sx={{ fontSize: '1.1rem', lineHeight: 1.6 }}>
            Hi, I'm <strong>Shaikh Mujahid</strong>, a passionate <strong>Java Full Stack Developer</strong> with a strong foundation in Computer Science Engineering. As a quick learner with a problem-solving mindset
             and solid Java fundamentals, I'm eager to kickstart my career in backend-focused roles. My internship experience has equipped me with practical skills in software development, and I'm excited to contribute to innovative projects.
          </Typography>
        </Box>
            ...
            <TimelineItem>
              ...
              <TimelineContent>
                <Card sx={{ backgroundColor: 'background.paper' }}>
                  <CardContent>
                    <Typography variant="h6">BE in Computer Science and Engineering</Typography>
